...
(
    ...
    constraint clients_card_clients foreign key (client_id) references clients (id),
...
create table cards-transactions
(
    card_id varchar(36) not null,
    transaction_id varchar(36) not null,
    constraint cards_transactions_unique (card_id, transaction_id),
